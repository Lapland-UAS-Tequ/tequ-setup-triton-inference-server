...
```
docker run --runtime nvidia --rm -p8000:8000 -p8001:8001 -p8002:8002 -v /home/tequ/model_repository:/models nvcr.io/nvidia/tritonserver:23.09-tf2-python-py3 tritonserver --model-repository=/models  --backend-config=tensorflow,version=2 --strict-model-config=false
```
...
### Install numjs on Jetson (Tested on ubuntu 18.04 & Jetpack 4.6.1)
